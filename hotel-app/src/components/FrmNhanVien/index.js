            ...
            <Paper elevation={15} sx={{ marginTop: '10px', flexDirection: 'column', maxHeight: '40%', overflow: 'auto', padding: '15px' }}>
                        ...
                        <LocalizationProvider dateAdapter={AdapterDayjs} >
                            <DemoContainer components={['DatePicker']} >
                                <DatePicker
                                    ...
                                    sx={{ width: '100%' }}
                                    label="Ngày vào làm"
                                    value={nhanVienMoi && nhanVienMoi.ngayVaoLam ? nhanVienMoi.ngayVaoLam : dayjs('2001-04-30')}
                        ...
                        <LocalizationProvider dateAdapter={AdapterDayjs} >
                            <DemoContainer components={['DatePicker']} >
                                <DatePicker
                                    ...
                                    sx={{ width: '100%' }}
                                    label="Ngày sinh"
                                    value={nhanVienMoi && nhanVienMoi.ngaySinh ? nhanVienMoi.ngaySinh : dayjs('2001-04-30')}
                                    // onChange={(date) => setDateNgaySinh(date)}
                ...
                <Box sx={{ display: 'flex', height: '100px', mt: '10px' }}>
                    ...
                    <Box sx={{ width: '20%', alignItems: 'center', display: 'flex', marginLeft: '20px' }}>
                        <Button variant='contained' endIcon={<SearchOutlinedIcon />} size={'large'} onClick={() => { handleSearchNhanVien() }} >Tìm kiếm</Button>
                    </Box>
                </Box>
            </Paper>
            {/* Danh sách Nhân Viên */}
