      ...
      <div className="btn-container">
        ...
        <button className={`btn ${navSelected.guest && "btn-selected"}`}>
          ...
          {navSelected.guest && (
            <div className="sub-menu-container">
              <button
                className={`btn-sub ${subNavSelected.subnav === "manager-guest" &&
                  "btn-sub-selected"
                  }`}
        ...
        <button className={`btn ${navSelected.staff && "btn-selected"}`}>
          ...
          {navSelected.staff && (
            <div className="sub-menu-container">
              <button
                className={`btn-sub ${subNavSelected.subnav === "manager-staff" &&
                  "btn-sub-selected"
                  }`}
                onClick={() => onHandleSelectedSubNav("manager-staff", "staff")}
              >
                <GroupAddOutlinedIcon />
                <p className="btn-sub-title">Câp nhật</p>
              </button>
              <button
        ...
        <button className={`btn ${navSelected.service && "btn-selected"}`}>
          ...
          {navSelected.service && (
            <div className="sub-menu-container">
              <button
                className={`btn-sub ${subNavSelected.subnav === "manager-service" &&
                  "btn-sub-selected"
                  }`}
                onClick={() =>
