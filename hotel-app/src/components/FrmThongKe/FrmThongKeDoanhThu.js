...
function FrmThongKeDoanhThu() {
  ...
  const [dsHoaDonDaThanhToanDeThongKe, setDSHoaDonDaThanhToanDeThongKe] =
    useState(undefined);
  const [
  ...
  const [
    detailReportDoanhThuPhongVaDichVuTheoThang,
    setDetailReportDoanhThuPhongVaDichVuTheoThang,
  ] = useState(false);
  const [
    detailReportDoanhThuPhongVaDichVu,
    setDetailReportDoanhThuPhongVaDichVu,
  ] = useState(false);
  ...
  const [
    dsHoaDonChartTheoTungNgayCuaThang,
    setDSHoaDonChartTheoTungNgayCuaThang,
  ] = useState(undefined);
  const [dsHoaDonChartTheoThang1, setDSHoaDonChartTheoThang1] =
    useState(undefined);
  const [dsHoaDonChartTheoThang2, setDSHoaDonChartTheoThang2] =
    useState(undefined);
  const [dsHoaDonChartTheoThang3, setDSHoaDonChartTheoThang3] =
    useState(undefined);
  const [dsHoaDonChartTheoThang4, setDSHoaDonChartTheoThang4] =
    useState(undefined);
  const [dsHoaDonChartTheoThang5, setDSHoaDonChartTheoThang5] =
    useState(undefined);
  const [dsHoaDonChartTheoThang6, setDSHoaDonChartTheoThang6] =
    useState(undefined);
  const [dsHoaDonChartTheoThang7, setDSHoaDonChartTheoThang7] =
    useState(undefined);
  const [dsHoaDonChartTheoThang8, setDSHoaDonChartTheoThang8] =
    useState(undefined);
  const [dsHoaDonChartTheoThang9, setDSHoaDonChartTheoThang9] =
    useState(undefined);
  const [dsHoaDonChartTheoThang10, setDSHoaDonChartTheoThang10] =
    useState(undefined);
  const [dsHoaDonChartTheoThang11, setDSHoaDonChartTheoThang11] =
    useState(undefined);
  const [dsHoaDonChartTheoThang12, setDSHoaDonChartTheoThang12] =
    useState(undefined);
  ...
  const tinhTongTienPhong = (data) => {
    ...
    data.dsPhong.map((phong, index) => {
      ...
      if (
        ...
        if (
          new Date(data.ngayTraPhong).getHours() > 11 &&
          new Date(data.ngayTraPhong).getHours() <= 15
        ) {
          prices += phong.giaPhong * totalDates + phong.giaPhong * 0.3;
        } else if (
          new Date(data.ngayTraPhong).getHours() > 14 &&
          new Date(data.ngayTraPhong).getHours() <= 18
        ) {
          prices += phong.giaPhong * totalDates + phong.giaPhong * 0.5;
        } else if (new Date(data.ngayTraPhong).getHours() > 17) {
          prices += phong.giaPhong * totalDates + phong.giaPhong;
        } else {
          prices += phong.giaPhong * totalDates;
        }
      } else {
        prices += phong.giaPhong * totalDates;
      }
    ...
    data.dsPhong.map((phong, index) => {
      ...
      if (
        ...
        if (
          ...
          pricePhong += phong.giaPhong * totalDates + phong.giaPhong * 0.3;
        } else if (
          new Date(data.ngayTraPhong).getHours() > 14 &&
          new Date(data.ngayTraPhong).getHours() <= 18
        ) {
          pricePhong += phong.giaPhong * totalDates + phong.giaPhong * 0.5;
        } else if (new Date(data.ngayTraPhong).getHours() > 17) {
          pricePhong += phong.giaPhong * totalDates + phong.giaPhong;
        } else {
          pricePhong += phong.giaPhong * totalDates;
        }
      } else {
        pricePhong += phong.giaPhong * totalDates;
      }
  ...
  useEffect(() => {
    if (dsHoaDonChartTheoThang1 !== undefined) {
      setDSHoaDonChartTheoThang((prestate) => [
        ...prestate,
  ...
  const handlePrint = () => {
    setCurrentTongTienNam(
      dsTongTienTemp.reduce((preValue, currentValue) => preValue + currentValue)
    );
    setOpenPopupPrint(true);
    setIsPrintHoaDonTheoNam(true);
  };
  const handlePrintThang = () => {
    setCurrentTongTienThang(
      dsTongTienTempThang.reduce(
  ...
  const createObjectHoaDonTheoThang = () => {
    dsHoaDonDaThanhToanDeThongKe &&
      ...
      dsHoaDonDaThanhToanDeThongKe.map((hoadon, index) => {
        ...
        if (month === "04") {
          ...
          if (
            tinhTongTienPhongThang4 &&
            tinhTongTienDichVuThang4 &&
            tinhTongTienPhongVaDichVuThang4
          ) {
            if (dsTongTienPhongTempThang4.length > 0) {
              ...
              setDSHoaDonChartTheoThang4({
                name: "Tháng 4",
                tienPhong: dsTongTienPhongTempThang4.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang4.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang4.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang3 &&
            tinhTongTienDichVuThang3 &&
            tinhTongTienPhongVaDichVuThang3
          ) {
            if (dsTongTienPhongTempThang3.length > 0) {
              ...
              setDSHoaDonChartTheoThang3({
                name: "Tháng 3",
                tienPhong: dsTongTienPhongTempThang3.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang3.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang3.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang1 &&
            tinhTongTienDichVuThang1 &&
            tinhTongTienPhongVaDichVuThang1
          ) {
            if (dsTongTienPhongTempThang1.length > 0) {
              // console.log("Tong Tien Tháng ba Reduce:", dsTongTienPhongTempThang3.reduce((preValue, currentValue) => preValue + currentValue));
              setDSHoaDonChartTheoThang1({
                name: "Tháng 1",
                tienPhong: dsTongTienPhongTempThang1.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang1.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang1.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang2 &&
            tinhTongTienDichVuThang2 &&
            tinhTongTienPhongVaDichVuThang2
          ) {
            if (dsTongTienPhongTempThang2.length > 0) {
              setDSHoaDonChartTheoThang2({
                name: "Tháng 2",
                tienPhong: dsTongTienPhongTempThang2.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang2.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang2.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang5 &&
            tinhTongTienDichVuThang5 &&
            tinhTongTienPhongVaDichVuThang5
          ) {
            if (dsTongTienPhongTempThang5.length > 0) {
              setDSHoaDonChartTheoThang5({
                name: "Tháng 5",
                tienPhong: dsTongTienPhongTempThang5.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang5.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang5.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang6 &&
            tinhTongTienDichVuThang6 &&
            tinhTongTienPhongVaDichVuThang6
          ) {
            if (dsTongTienPhongTempThang6.length > 0) {
              setDSHoaDonChartTheoThang6({
                name: "Tháng 6",
                tienPhong: dsTongTienPhongTempThang6.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang6.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang6.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang7 &&
            tinhTongTienDichVuThang7 &&
            tinhTongTienPhongVaDichVuThang7
          ) {
            if (dsTongTienPhongTempThang7.length > 0) {
              setDSHoaDonChartTheoThang7({
                name: "Tháng 7",
                tienPhong: dsTongTienPhongTempThang7.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang7.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang7.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang8 &&
            tinhTongTienDichVuThang8 &&
            tinhTongTienPhongVaDichVuThang8
          ) {
            if (dsTongTienPhongTempThang8.length > 0) {
              setDSHoaDonChartTheoThang8({
                name: "Tháng 8",
                tienPhong: dsTongTienPhongTempThang8.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang8.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang8.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang9 &&
            tinhTongTienDichVuThang9 &&
            tinhTongTienPhongVaDichVuThang9
          ) {
            if (dsTongTienPhongTempThang9.length > 0) {
              setDSHoaDonChartTheoThang9({
                name: "Tháng 9",
                tienPhong: dsTongTienPhongTempThang9.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang9.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang9.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang10 &&
            tinhTongTienDichVuThang10 &&
            tinhTongTienPhongVaDichVuThang10
          ) {
            if (dsTongTienPhongTempThang10.length > 0) {
              setDSHoaDonChartTheoThang10({
                name: "Tháng 10",
                tienPhong: dsTongTienPhongTempThang10.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang10.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang10.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang11 &&
            tinhTongTienDichVuThang11 &&
            tinhTongTienPhongVaDichVuThang11
          ) {
            if (dsTongTienPhongTempThang11.length > 0) {
              setDSHoaDonChartTheoThang11({
                name: "Tháng 11",
                tienPhong: dsTongTienPhongTempThang11.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang11.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang11.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
          ...
          if (
            tinhTongTienPhongThang12 &&
            tinhTongTienDichVuThang12 &&
            tinhTongTienPhongVaDichVuThang12
          ) {
            if (dsTongTienPhongTempThang12.length > 0) {
              setDSHoaDonChartTheoThang12({
                name: "Tháng 12",
                tienPhong: dsTongTienPhongTempThang12.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tienDichVu: dsTongTienDichVuTempThang12.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
                tongTien: dsTongTienPhongVaDichVuThang12.reduce(
                  (preValue, currentValue) => preValue + currentValue
                ),
              });
            }
  ...
  const getAllBillTheoThangCoTongTienPhongVaDichVuTheoThang = () => {
    ...
    dsHoaDonDaThanhToanDeThongKeTheoThang &&
      ...
      dsHoaDonDaThanhToanDeThongKeTheoThang.map((data) => {
        setDsAllBillTheoThangTemp((prestate) => [
          ...prestate,
          {
  ...
  const getAllHoaDonChartThang = (dsAllBillTheoThangTemp) => {
    const dates = [
      ...new Set(dsAllBillTheoThangTemp.map((bill) => bill.ngayLap)),
    ];
    const result = dates.map((date) => {
      const bills = dsAllBillTheoThangTemp.filter(
        (bill) => bill.ngayLap === date
      );
    ...
    <StyledContainer>
      ...
      <Grid container spacing={2}>
        <Grid item md={12}>
          <Autocomplete
            onChange={(e, value) => {
              handleOnchangeSelectedCombobox(e, value);
            }}
            disablePortal
            id="combo-box-demo"
            ...
            sx={{ width: "100%" }}
            renderInput={(params) => (
              <TextField {...params} label="Thống kê tổng doanh thu" disabled />
            )}
          />
        </Grid>

        <Grid item md={12}>
          {search.theo === "Theo năm" && (
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DemoContainer components={["DatePicker"]}>
                <DatePicker
                  ...
                  views={["year"]}
                  onChange={(date) => {
                    handlOnChangeTuNgay(date);
                  }}
                />
              </DemoContainer>
            </LocalizationProvider>
          )}
          {search.theo === "Theo tháng" && (
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DemoContainer components={["DatePicker"]}>
                <DatePicker
                  sx={{ width: "100%" }}
        ...
        <Grid item md={4}>
          {search.theo === "Theo năm" && (
            <Button
              ...
              size="medium"
              onClick={() => {
                handleThongKeDoanhThuTheoPhong();
              }}
            >
              Thống kê theo năm{" "}
            </Button>
          ...
          {search.theo === "Theo tháng" && (
            <Button
              ...
              size="medium"
              onClick={() => {
                handleThongKeDoanhThuTheoThang();
              }}
            >
              Thống kê theo tháng{" "}
            </Button>
        ...
        <Grid item md={4}>
          {search.theo === "Theo năm" &&
            detailReportDoanhThuPhongVaDichVu === true && (
              <Button
                fullWidth
                variant="contained"
          ...
          {search.theo === "Theo tháng" &&
            detailReportDoanhThuPhongVaDichVuTheoThang === true && (
              <Button
                fullWidth
                variant="contained"
                endIcon={<LocalPrintshopOutlinedIcon />}
                ...
                dsHoaDonDaThanhToanDeThongKe.length > 0 ? (
                  dsHoaDonDaThanhToanDeThongKe.map((data) => (
                    <tr key={data.maHoaDon}>
                      <td>{data.maHoaDon}</td>
                      <td>{moment(data.ngayLap).format("DD/MM/YYYY HH:MM")}</td>
                      <td>{data.khachHang.hoTen}</td>

                      <td>{data.nhanVien.hoTen}</td>
                      <td>
                        {moment(data.ngayNhanPhong).format("DD/MM/YYYY HH:MM")}
                      </td>
                      <td>
                        {moment(data.ngayTraPhong).format("DD/MM/YYYY HH:MM")}
                      </td>
                      <td>
                        {data.dsPhong.map((phong, index) => {
                ...
                dsHoaDonDaThanhToanDeThongKeTheoThang.length > 0 ? (
                  dsHoaDonDaThanhToanDeThongKeTheoThang.map((data) => (
                    <tr key={data.maHoaDon}>
                      ...
                      <td>
                        {`${tinhTongTienDichVuThang(
                          data
                        ).toLocaleString()} VND`}
                      </td>
                      <td>
                        {`${tinhTongTienPhongVaDichVuThang(
                          data
                        ).toLocaleString()} VND`}
                      </td>
                    </tr>
      ...
      {dsHoaDonDaThanhToanDeThongKe &&
        dsHoaDonDaThanhToanDeThongKe.length > 0 &&
        detailReportDoanhThuPhongVaDichVu === false && (
          <Stack mt="35px" overflow="hidden">
      ...
      {dsHoaDonDaThanhToanDeThongKeTheoThang &&
        dsHoaDonDaThanhToanDeThongKeTheoThang.length > 0 &&
        detailReportDoanhThuPhongVaDichVuTheoThang === false && (
          <Stack mt="35px" overflow="hidden">
            <ResponsiveContainer width="100%" height={450}>
              <ComposedChart
                width={500}
      ...
      <PopupPrintHoaDonTheoPhong
        openPopupPrint={openPopupPrint}
        setOpenPopupPrint={setOpenPopupPrint}
        isPrinHoaDonTheoNam={isPrinHoaDonTheoNam}
        dsHoaDonDaThanhToanDeThongKe={dsHoaDonDaThanhToanDeThongKe}
        currentTongTienNam={currentTongTienNam}
        currentTongTienThang={currentTongTienThang}
        dsHoaDonDaThanhToanDeThongKeTheoThang={
          dsHoaDonDaThanhToanDeThongKeTheoThang
        }
        search={search}
